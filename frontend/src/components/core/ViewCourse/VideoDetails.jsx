...
const VideoDetails = () => {
  ...
  const isFirstVideo = () => {
    ...
    if (currentSectionIndx === -1 || !courseSectionData[currentSectionIndx]?.subSection) return false
              ...
              <div className="mt-10 flex min-w-[250px] justify-center gap-x-4 text-xl">
                {!isFirstVideo() && (
                  <button
                    ...
                    className="px-6 py-2 bg-richblack-700 border border-richblack-600 rounded-lg hover:bg-richblack-600 transition-colors text-white font-medium"
                  >
                    Prev
                  </button>
                )}
